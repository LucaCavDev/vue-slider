...
var app = new Vue({
  ...
  methods: {
    nextPic: function () {
      ...
      if(this.indexPic > (this.pics.length - 1)){
        //allora si torna all'immagine di partenza, con indice0
        this.indexPic = 0;
      }
      console.log('next', this.indexPic);
    },
    ...
    prevPic: function () {
      ...
      if (this.indexPic < 0){
        ...
        this.indexPic = this.pics.length - 1;
      }
      console.log('prev', this.indexPic);
    },

    cambiaImmagine: function (indexPallino) {
    this.indexPic = indexPallino;
  }
